        ...
        function o() {
          ...
          function d(n, r, t, e) {
            var o = r && r.prototype instanceof v ? r : v,
              ...
              c = new I(e || []);
            return i(a, "_invoke", { value: E(n, t, c) }), a;
          }
          function p(n, r, t) {
            try {
          ...
          function E(n, r, t) {
            ...
            return function (o, a) {
              ...
              for (t.method = o, t.arg = a; ; ) {
                ...
                if ("normal" === s.type) {
                  if (
                    ((e = t.done ? "completed" : "suspendedYield"), s.arg === h)
                  )
                    continue;
                  return { value: s.arg, done: t.done };
                }
                "throw" === s.type &&
                  ((e = "completed"), (t.method = "throw"), (t.arg = s.arg));
              }
            };
          }
          function S(n, r) {
            ...
            var e = p(t, n.iterator, r.arg);
            if ("throw" === e.type)
              return (
                (r.method = "throw"), (r.arg = e.arg), (r.delegate = null), h
              );
            var o = e.arg;
            return o
              ? o.done
            ...
            (I.prototype = {
              ...
              finish: function (n) {
                for (var r = this.tryEntries.length - 1; r >= 0; --r) {
                  ...
                  if (t.finallyLoc === n)
                    return this.complete(t.completion, t.afterLoc), j(t), h;
                }
              },
              catch: function (n) {
                for (var r = this.tryEntries.length - 1; r >= 0; --r) {
                ...
                for (;;)
                  switch ((n.prev = n.next)) {
                    ...
                    case 9:
                      return (
                        (a = n.sent),
                        console.log("result.todo", a),
                        n.abrupt("return", null == a ? void 0 : a.todo)
                      );
                    case 12:
                    case "end":
                      return n.stop();
